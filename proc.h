...
#define PRWAITFORLOCK	'\011'		//waiting for a lock
...
struct	pentry	{
	...
	int	pwaitret;
	int	lock_assign_tab[50];	/* locks assigned to this process */
	int	pretval_isDELETED;	//returns DELETEDif process waiting on a deleted lock	
	unsigned long 	lockwaitingtime;
	int	pinh;
	int 	lockid_waiting;
};
